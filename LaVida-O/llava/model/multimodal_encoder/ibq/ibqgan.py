...
def build_ibq():
    ...
    config_path = os.path.join(dir_name, "/sensei-fs-3/users/shufanl/LaViDa/llava/model/multimodal_encoder/ibq/pretrain_ibqgan_16384.yaml")
...
if __name__ == "__main__":
    '''
    python -m llava.model.multimodal_encoder.ibq.ibqgan
    '''
