        ...
        **kwargs,
        ...
        for i in range(0, total, generation_batch_size):
            ...
            if gen_type == "text_gen":
                ...
                if use_bbox:
                    if input_embeds_grounding is None or attention_mask_grounding is None or bbox_mask_grounding is None:
                        raise ValueError(f"Grounding tensors: input_embeds_grounding / attention_mask_grounding / bbox_mask_grounding")
        ...
        if gen_type == "image_gen":
            ...
            result.update({
                ...
                "pred_bboxes": pred_bboxes_all if use_bbox else [],
